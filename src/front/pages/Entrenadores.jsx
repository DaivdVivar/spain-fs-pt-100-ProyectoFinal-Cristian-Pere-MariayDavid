                    ...
                    <div className="alerta-entrenador text-center mx-auto my-3">
                        ...
                        <div className="d-flex justify-content-center align-items-center gap-3 mt-2 flex-wrap">
                            <div>
                                ...
                                <img
                                    src={mensajeCambio.anterior?.imagen || "https://res.cloudinary.com/dchrsbres/image/upload/v1750753610/dcy10ssid2lusqbftqrk.png"}
                            ...
                            <div>
                                ...
                                <img
                                    src={mensajeCambio.nuevo?.imagen || "https://res.cloudinary.com/dchrsbres/image/upload/v1750753610/dcy10ssid2lusqbftqrk.png"}
                    ...
                    <div className="trainer-card-1 trainer-destacado p-4 rounded shadow d-flex justify-content-center align-items-center">
                        <div className="entrenador-grid">
                            ...
                            <div className="col-centro text-center">
                                <img
                                    src={store.user.profesionales_contratados[0].imagen || "https://res.cloudinary.com/dchrsbres/image/upload/v1750753610/dcy10ssid2lusqbftqrk.png"}
                            ...
                            <div className="col-md-6" key={index}>
                                <div className="trainer-card-1 d-flex flex-column p-3 rounded shadow h-100 justify-content-between">
                                    <div className="d-flex align-items-center">
                                        <img
                                            src={trainer.imagen || "https://res.cloudinary.com/dchrsbres/image/upload/v1750753610/dcy10ssid2lusqbftqrk.png"}
